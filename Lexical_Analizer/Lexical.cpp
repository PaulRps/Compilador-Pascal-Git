...
Lexical *Lexical::instance_ = nullptr;
...
Lexical::Lexical(): current_position_(0), initial_position_(0), numberLine_(1), state_(START){
    initMap_KeyWords();
}
        ...
        switch (state_) {
            ...
            case OPENING_STRING: // ''
                ...
                if(isdigit(code[current_position_]) || isalpha(code[current_position_]) ){
                    ...
                    // Error::error_message("don't close string","Lexical", code[current_position_], numberLine_);
            ...
            case COMMENT_NOT_CLOSE://error
                ...
                // Error::error_message("don't close comment","Lexical", code[current_position_], numberLine_);
            ...
            case UNKNOW_SYMBOL://error
                ...
                // Error::error_message("unknown symbol","Lexical", code[current_position_], numberLine_);
...
void Lexical::showTokens(){
    ...
    for(; it != tokens_.end(); it++){
        ...
        cerr << "token: " << it->getToken() << " \tcategoria: " << it->getCategory() << "\ttype: " << it->getType() << " \tlinha: " << it->getLine() << "\n";
